package me.videogamesm12.w2k.drivers.v1_15.mixin.wrapping;
...
public abstract class EntityWrappingMixin implements WrappedEntity
{
	...
	@Shadow public abstract CompoundTag toTag(CompoundTag par1);
	...
	{
		return toTag(new CompoundTag()).toString();
	}
