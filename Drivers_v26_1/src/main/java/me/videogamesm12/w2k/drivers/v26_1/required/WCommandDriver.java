...
public class WCommandDriver implements me.videogamesm12.w2k.kernel.driver.base.WCommandDriver
{
    ...
    public void registerCommand(WCommand command)
    {
        ...
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, access) ->
                dispatcher.register(ClientCommands.literal(command.getName()).executes(wrapped)
                        .then(ClientCommands.argument("args", StringArgumentType.greedyString()).executes(wrapped))));
    }
}
