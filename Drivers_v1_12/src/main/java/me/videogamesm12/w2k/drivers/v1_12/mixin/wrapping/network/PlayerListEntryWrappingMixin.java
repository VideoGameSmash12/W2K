package me.videogamesm12.w2k.drivers.v1_12.mixin.wrapping.network;
...
public abstract class PlayerListEntryWrappingMixin implements WrappedPlayerListEntry
{
	...
	{
		return ComponentUtils.stringToElement(Text.Serializer.serialize(getDisplayName()));
	}
	...
	{
		return getGameMode().getGameModeName();
	}
