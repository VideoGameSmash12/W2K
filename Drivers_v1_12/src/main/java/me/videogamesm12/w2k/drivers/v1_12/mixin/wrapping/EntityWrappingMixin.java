package me.videogamesm12.w2k.drivers.v1_12.mixin.wrapping;
...
public abstract class EntityWrappingMixin implements WrappedEntity
{
	...
	@Shadow public abstract NbtCompound toNbt(NbtCompound nbt);
	...
	{
		return toNbt(new NbtCompound()).toString();
	}
