package me.videogamesm12.w2k.val.v26_1_x.command.arguments;
...
public class ExperimentArgument implements ArgumentType<Experiment>
{
    private static final Component INVALID_EXPERIMENT = Component.translatable("w2k.command.experiments.invalid_experiment");

    private final Filter filter;

    public static ExperimentArgument all()
    {
        return new ExperimentArgument(Filter.ALL);
    }

    public static ExperimentArgument runtimeOnly()
    {
        return new ExperimentArgument(Filter.RUNTIME);
    }

    public static ExperimentArgument unavailableOnly()
    {
        return new ExperimentArgument(Filter.UNAVAILABLE);
    }

    public static ExperimentArgument togglable()
    {
        return new ExperimentArgument(Filter.TOGGLABLE);
    }
    ...
    public enum Filter
    {
        ALL(experiment -> true, ignored -> Component.translatable("w2k.command.experiments.invalid_experiment")),
