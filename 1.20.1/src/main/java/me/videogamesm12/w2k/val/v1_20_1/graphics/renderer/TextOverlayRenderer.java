...
public class TextOverlayRenderer extends AbstractOverlayRenderer<TextOverlay>
{
    ...
    public void renderOverlay(TextOverlay overlay, DrawContext context)
    {
        ...
        // Compared
        final List<Text> compiled = overlay.getCompiledText();
    ...
    private void textLine(TextOverlay overlay, DrawContext context, Text text, int baseX, int baseY, int level, Overlay.Alignment horizontal, Overlay.Alignment vertical)
    {
        ...
        int totalHeight = overlay.getCompiledText().size() * renderer.fontHeight;
