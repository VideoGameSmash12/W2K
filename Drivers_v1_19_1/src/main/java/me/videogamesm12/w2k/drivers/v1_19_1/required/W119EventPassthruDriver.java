...
@WDriverMetadata(identifier = "191_event_passthru", maxVersion = "1.19.1", minVersion = "1.19.1", minProtocolVersion = 0, maxProtocolVersion = 0)
public class W119EventPassthruDriver implements WEventPassThruDriver, ClientLifecycleEvents.ClientStarted, ClientLifecycleEvents.ClientStopping
{
    @Override
