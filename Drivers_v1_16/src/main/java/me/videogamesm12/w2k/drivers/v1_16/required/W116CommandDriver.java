...
@WDriverMetadata(identifier = "16_command_wrapper", minVersion = "1.16.5", maxVersion = "1.16.5", minProtocolVersion = 0, maxProtocolVersion = 0)
public class W116CommandDriver implements WCommandDriver
{
    @Override
