...
{
    public static JCheckBoxMenuItem createCheckboxMenuItem(final String label,
    ...
    public static JCheckBoxMenuItem createCheckboxMenuItem(final String label,
                                                           final String tooltip,
                                                           final Supplier<Boolean> getter,
                                                           final BiConsumer<JCheckBoxMenuItem, Boolean> setter)
    {
        final JCheckBoxMenuItem checkbox = new JCheckBoxMenuItem(label, getter.get());
        if (tooltip != null)
            checkbox.setToolTipText(tooltip);
        checkbox.addActionListener(e -> setter.accept(checkbox, checkbox.isSelected()));
        return checkbox;
    }
