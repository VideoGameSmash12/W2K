...
import me.videogamesm12.w2k.drivers.v1_21_4.command.ClientEntityArgumentType;
import me.videogamesm12.w2k.drivers.v1_21_4.command.ExperimentArgumentType;
import me.videogamesm12.w2k.drivers.v1_21_4.command.OnlinePlayersArgumentType;
import me.videogamesm12.w2k.drivers.v1_21_4.command.WModuleArgumentType;
...
@WDriverMetadata(identifier = "1212_command_wrapper")
public class W1212CommandDriver implements WCommandDriver
{
    private final Map<String, BrigadierArgumentResolver<?, ?>> resolverMap = new HashMap<>();

    public W1212CommandDriver()
    {
