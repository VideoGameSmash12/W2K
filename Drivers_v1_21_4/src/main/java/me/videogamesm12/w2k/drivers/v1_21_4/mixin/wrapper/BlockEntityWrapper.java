...
public abstract class BlockEntityWrapper implements IBlockEntityEntry
{
    ...
    @Shadow
    public abstract NbtCompound toInitialChunkDataNbt(RegistryWrapper.WrapperLookup registries);
    ...
    {
        return toInitialChunkDataNbt(Objects.requireNonNull(world).getRegistryManager()).toString();
    }
}
