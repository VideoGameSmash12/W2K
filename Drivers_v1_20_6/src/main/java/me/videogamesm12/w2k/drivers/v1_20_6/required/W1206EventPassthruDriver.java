...
@WDriverMetadata(identifier = "1206_event_passthru")
public class W1206EventPassthruDriver implements WEventPassThruDriver, ClientLifecycleEvents.ClientStarted, ClientLifecycleEvents.ClientStopping
{
    @Override
